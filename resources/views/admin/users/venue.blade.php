...
@section('venues-table', 'text-dark')
    ...
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            <div class="mb-2 d-flex justify-content-between align-items-center">
                <div class="d-flex">
                    <h6 class="m-2"><a class="@yield ('venues-table')" href="{{ route('users.index') }}">User Table</a></h6>
                    <span>/</span>
                    <h6 class="m-2 "><a href="{{ route('users.venue.index') }}">Venue
                            Table</a></h6>
                    <span>/</span>
                    <h6 class="m-2 "><a class="@yield ('venues-table')" href="{{ route('users.admin.index') }}">Admin
                            Table</a></h6>
                </div>
