            ...
            <div class="col-12 mb-5">
                <div class="tabs">
                    <ul class="tabs-nav flex">
                        ...
                        <li class="tab-nav flex justify-content-center align-items-center" data-target="#tab_booking">
                            Booking History
                        </li>
                    </ul>
                    <div class="tabs-container">
                                ...
                                <div class="bg-light rounded h-100 p-4">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            @if ($user->image)
                                                <img src="{{ $user->image !== 'default.png' ? asset('storage/' . $user->image) : asset('storage/uploads/default.png') }}"
                                                    alt="Current Image" class="img-fluid mt-2" style="width: 100px;">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <a href="{{ route('user.profile.passEdit') }}" class="btn dark w-100">Reset
                                                Password</a>
                                        </div>
                                    </div>
                        ...
                        <div id="tab_booking" class="tab-booking">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($user->bookings as $booking)
                                            <tr>
                                                <td>{{ $count++ }}</td>
                                                <td>{{ $booking->activity->name ?? 'N/A' }}</td> <!-- اسم النشاط -->
                                                <td>{{ $booking->venue->name ?? 'N/A' }}</td> <!-- اسم المكان -->
                                                <td>{{ \Carbon\Carbon::parse($booking->booking_date)->format('d/m/Y') }}
                                                </td> <!-- تاريخ الحجز -->
                                                <td>{{ \Carbon\Carbon::parse($booking->booking_time)->format('h:i A') }}
                                                </td> <!-- وقت الحجز -->
                                                <td>{{ $booking->companions }}</td> <!-- عدد المرافقين -->
                                                <td>{{ $booking->status }}</td> <!-- حالة الحجز -->
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
