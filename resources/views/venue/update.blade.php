            ...
            <div class="row">
                <div class="col-12">
                    <header class="entry-header">
                        <h1 class="entry-title">Edit Your Venue Details</h1>
                    </header>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="event-content-wrap">
                    ...
                    <div class="mb-3">
                        <form action="{{ route('venue.update.details') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{ old('name', $venue->name) }}"
                                        name="name" placeholder="Venue Name">
                                </div>
                                @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @if ($venue->image)
                                        <img src="{{ asset('storage/' . $venue->image) }}" alt="Current Venue Image"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                        value="{{ old('description', $venue->description) }}" name="description">
                                </div>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="type" id="male"
                                            value="male" {{ old('type', $venue->type) == 'male' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="type" id="female"
                                            value="female" {{ old('type', $venue->type) == 'female' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="type" id="both"
                                            value="both" {{ old('type', $venue->type) == 'both' ? 'checked' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="tel" class="form-control" name="phone" placeholder="Phone Number"
                                        pattern="07[7-9][0-9]{7}" value="{{ $venue->phone }}" required>
                                    @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                                ...
                                                @foreach ($allTags as $tag)
                                                    <div class="form-check">
                                                        <input class="form-check-input tag-checkbox" type="checkbox"
                                                            ...
                                                            {{ in_array($tag->tag_id, old('tags', $venue->tags->pluck('tag_id')->toArray())) ? 'checked' : '' }}>
                            ...
                            <button type="submit" class="btn gradient-bg w-100">Update Venue</button>
                        </form>
                    </div>
                </div>
            </div>
