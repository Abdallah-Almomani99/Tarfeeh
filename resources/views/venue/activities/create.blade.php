            ...
            <div class="row">
                <div class="col-12">
                    <header class="entry-header">
                        <h1 class="entry-title">Create Activity</h1>
                    </header>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="event-content-wrap">
                    ...
                    <div class="mb-3">
                        <form action="{{ route('venue.store.activity') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <button type="submit" class="btn gradient-bg w-100">Create Activity</button>
                        </form>
                    </div>
                </div>
            </div>
